document.addEventListener('DOMContentLoaded', () => {
    ...
    function displayCamion() {
      ...
      const filteredCamion = cars.filter(carData => carData.type === 'camion');
  
      filteredCamion.forEach((carData, index) => {
    ...
    if (window.location.pathname.includes(`cars-camion.html`)) {
      displayCamion();
    }
